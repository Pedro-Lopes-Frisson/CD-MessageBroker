...
root = "/" + "".join(random.sample(string.ascii_lowercase, 2))
leaf1 = root + "/" + "".join(random.sample(string.ascii_lowercase, 2))
leaf2 = root + "/" + "".join(random.sample(string.ascii_lowercase, 2))
